...
1. ¿Existe código implementado con `/developer`? → Si NO, completar `/developer` primero
2. ¿Existe plan de tests en `/architect`? → Seguir los casos identificados
...
Ejecutar `/security-auditor` para auditoría de seguridad.
