...
- Si existe `CLAUDE.md` en la raíz → Leerlo para conocer stack, convenciones y patrones existentes
- Si NO existe → Sugerir ejecutar `/init` primero o preguntar sobre el stack
...
## CHECKLIST ANTES DE PASAR A /developer
