...
## 12. Skills Obligatorias al Escribir Código

- Antes de escribir o modificar cualquier archivo Java de producción (fuera de `src/test/`): invocar la skill **`java-spring-boot`**.
- Antes de escribir o modificar cualquier archivo de test (`*Test.java`, `src/test/**`): invocar la skill **`junit-mockito`**.


## 13. Cambios Quirúrgicos
