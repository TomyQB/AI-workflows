...
1. Estamos trabajando en opencode CLI

2. Todo lo que generes que no sea expresamente del proyecto, como documentación, contextos, scripts temporales metelo en una carpeta en la raiz del proyecto llamada .code